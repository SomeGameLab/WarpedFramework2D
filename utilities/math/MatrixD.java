...
public class MatrixD {
	...
	public void add(MatrixD mat) {
		if(!getSize().equals(mat.getSize())) {
			System.err.println("MatrixDouble -> tried to add matricies of inconsistent size :"); 
			mat.getSize().println();
			mat.getSize().println();
			return;
		}
	...
	public void multiply(MatrixD mat) {
		if(!canMultiply(this,mat)) {
			System.err.println("MatrixDouble -> can't multiply matricies because they are incompatible -> Matrix Size : ");
	...
	public static MatrixD addition(MatrixD mat1, MatrixD mat2) { // Matrix 1 + matrix 2
		if(!mat1.getSize().equals(mat2.getSize())) {
			System.err.println("MatrixDouble -> tried to add matricies of inconsistent size :"); 
	...
	public static MatrixD multiplication(Vec2d vec, MatrixD mat) {
		if(Vec2d.getN() != mat.getM()) {
			System.err.println("MatrixDouble -> can't multiply Vec2d with matrix because they are incompatible -> Matrix Size : ");
			mat.getSize().println();
			return null;
		}
	...
	public static MatrixD multiplication(Vec3d vec, MatrixD mat) {
		if(Vec3d.getN() != mat.getM()) {
			System.err.println("MatrixDouble -> can't multiply Vec3d with matrix because they are incompatible -> Matrix Size : ");
			mat.getSize().println();
			return null;
		}
	...
	public static MatrixD multiplication(MatrixD mat1, MatrixD mat2) {
		if(!canMultiply(mat1,mat2)) {
			System.err.println("MatrixDouble -> can't multiply matricies because they are incompatible");
			mat1.getSize().println();
			mat2.getSize().println();
			return null;
		}
