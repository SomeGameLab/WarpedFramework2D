...
public class MatrixI {
	...
	public void add(MatrixI mat) {
		if(!getSize().equals(mat.getSize())) {
			System.err.println("MatrixInt -> tried to add matricies of inconsistent size :"); 
			mat.getSize().println();
			mat.getSize().println();
			return;
		}
	...
	public void multiply(MatrixI mat) {
		if(!canMultiply(this,mat)) {
			System.err.println("MatrixInt -> can't multiply matricies because they are incompatible -> Matrix Size : ");
	...
	public static MatrixI multiplication(Vec2i vec, MatrixI mat) {
		if(Vec2i.getN() != mat.getM()) {
			System.err.println("MatrixInt -> can't multiply Vec2i with matrix because they are incompatible -> Matrix Size : ");
			mat.getSize().println();
			return null;
		}
	...
	public static MatrixI multiplication(MatrixI mat1, MatrixI mat2) {
		if(!canMultiply(mat1,mat2)) {
			System.err.println("MatrixInt -> can't multiply matricies because they are incompatible");
			mat1.getSize().println();
			mat2.getSize().println();
			return null;
		}
